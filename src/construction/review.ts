...
import type { SourceNativeObjectIdentity, SourceNativeSource } from '../source/object-map.js';
import {
  assertSemanticConstructionBound,
  assertSemanticConstructionMetadataBound,
  validateSourceNativeSemanticConstruction,
} from './compiler.js';
import type { SourceNativeSemanticConstruction, SourceNativeSemanticWitness } from './compiler.js';
