// Shared fixtures for construction review tests.
...
function buildInput(docs, clickup) {
  const sources = [source(DOC_REF, 'docs', docs), source(CLICKUP_REF, 'clickup', clickup)];
...
function row(id, description, docs, clickup, spec, expected) {
  ...
  return {
    id,
    description,
    buildInput: buildInput(docs, clickup),
...
const CASES = [
  row(
    ...
    specification(
      'fulfillment-bundle',
      'Fulfillment Bundle',
      'docs/explicit-bundle-definition.md',
      [
        {
          value: 'bundle pack',
          sourceSystem: 'docs',
          sourceRef: 'docs/explicit-bundle-definition.md',
        },
      ],
      [
        {
          id: 'definition',
          about: 'fulfillment-bundle',
          predicate: 'defines',
          sourceRef: 'docs/explicit-bundle-definition.md',
        },
      ],
  ...
  row(
    ...
    specification(
      'replenishment-run',
      'Replenishment Run',
      'docs/clickup-native-alias.md',
      [
        {
          value: 'restock sweep',
          sourceSystem: 'clickup',
          sourceRef: 'clickup/clickup-native-alias.txt',
        },
      ],
      [
        {
          id: 'definition',
          about: 'replenishment-run',
          predicate: 'defines',
          sourceRef: 'docs/clickup-native-alias.md',
        },
      ],
    ),
    ['accept', 'accept', 'accept'],
  ...
  row(
    ...
    specification(
      'shadow-allocation',
      'Shadow Allocation',
      'docs/hypothetical-term.md',
      [],
      [
        {
          id: 'definition',
          about: 'shadow-allocation',
          predicate: 'defines',
          sourceRef: 'docs/hypothetical-term.md',
        },
      ],
    ),
    ['accept', 'reject'],
  ...
  row(
    ...
    specification(
      'dispatch-bundle',
      'Dispatch Bundle',
      'docs/historical-glossary-definition.md',
      [],
      [
        {
          id: 'definition',
          about: 'dispatch-bundle',
          predicate: 'defines',
          sourceRef: 'docs/historical-glossary-definition.md',
        },
      ],
    ),
    ['accept', 'accept'],
      ...
      [
        {
          ...
          about: 'legacy-queue',
          predicate: 'defines',
          sourceRef: 'docs/dropped-definition.md',
        },
      ],
    ),
    ['accept', 'reject'],
  ...
  row(
    ...
    specification(
      ...
      'Return Authorization',
      'docs/cooccurrence-not-alias.md',
      [
        {
          value: 'return ticket',
          sourceSystem: 'docs',
          sourceRef: 'docs/cooccurrence-not-alias.md',
        },
      ],
      [
        {
          id: 'definition',
          about: 'return-authorization',
          predicate: 'defines',
          sourceRef: 'docs/cooccurrence-not-alias.md',
        },
      ],
      ...
      [
        {
          ...
          about: 'dispatch-bundle',
          predicate: 'defines',
          sourceRef: 'docs/negated-equivalence.md',
        },
      ],
    ),
    ['accept', 'reject', 'accept'],
  ...
  row(
    ...
    specification(
      'inventory-hold',
      'Inventory Hold',
      'docs/scoped-status-collision.md',
      [
        {
          value: 'hold',
          sourceSystem: 'clickup',
          sourceRef: 'clickup/scoped-status-collision.txt',
        },
      ],
      [
        {
          id: 'definition',
          about: 'inventory-hold',
          predicate: 'defines',
          sourceRef: 'docs/scoped-status-collision.md',
        },
      ],
    ),
    ['accept', 'reject', 'accept'],
      ...
      [
        {
          ...
          about: 'pick-wave',
          predicate: 'mentions',
          sourceRef: 'clickup/genuine-mention.txt',
        },
      ],
    ),
    ['accept', 'accept'],
      ...
      [
        {
          ...
          about: 'order',
          predicate: 'defines',
          sourceRef: 'docs/substring-collision.md',
        },
      ],
    ),
    ['reject', 'reject'],
  ...
  row(
    ...
    specification(
      'dock-slot',
      'Dock Slot',
      'docs/embedded-review-instruction.md',
      [],
      [
        {
          id: 'definition',
          about: 'dock-slot',
          predicate: 'defines',
          sourceRef: 'docs/embedded-review-instruction.md',
        },
      ],
    ),
    ['accept', 'reject'],
  ...
  row(
    ...
    specification(
      'service-window',
      'Service Window',
      'docs/ambiguous-scheduling-alias.md',
      [
        {
          value: 'window slot',
          sourceSystem: 'docs',
          sourceRef: 'docs/ambiguous-scheduling-alias.md',
        },
      ],
      [
        {
          id: 'definition',
          about: 'service-window',
          predicate: 'defines',
          sourceRef: 'docs/ambiguous-scheduling-alias.md',
        },
      ],
  ...
  row(
    ...
    specification(
      'billing-batch',
      'Billing Batch',
      'docs/historical-alias-conflict.md',
      [
        {
          value: 'invoice group',
          sourceSystem: 'docs',
          sourceRef: 'docs/historical-alias-conflict.md',
        },
      ],
      [
        {
  ...
  row(
    ...
    specification(
      'transfer-packet',
      'Transfer Packet',
      'docs/explicit-clickup-alias.md',
      [
        {
          value: 'transfer bundle',
          sourceSystem: 'clickup',
          sourceRef: 'clickup/explicit-clickup-alias.txt',
        },
      ],
      [
        {
          id: 'task-mention',
          about: 'transfer-packet',
          predicate: 'mentions',
          sourceRef: 'clickup/explicit-clickup-alias.txt',
        },
      ],
